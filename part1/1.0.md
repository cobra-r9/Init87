...
date: 2026-06-12
description: "Before getting to know about the C type system, we need to understand what problem the C's type system was solving. The roots of this problem dates back to the beginning of the UNIX operating system and the role C played in making that."
...
## Links 
- [Next: Integer Types](./1.1.md)
- [Prev: The C Compilation Model](../part0/0.6.md)
- [Home](../index.md)
