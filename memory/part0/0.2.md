---
layout: default
title: "CPU and Memory Bus"
description: "This part deals with the truth - we think RAM is faster than CPU? I though it was. But actually, RAM is too slow to work with CPU and there is necessity of additional components, caches, buses, etc for RAM to coordinate with the CPU."
date: 2025-04-20
...
## Links 
- [Next: Registers](./0.3.md)
- [Prev: What Actually RAM Is](./0.1.md)
- [Home](../../index.md)
